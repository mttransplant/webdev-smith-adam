...
var PageEditComponent = (function () {
    ...
    PageEditComponent.prototype.handleRouteChange = function (routeParams) {
        var _this = this;
        this.activatedRoute.params
            .subscribe(function (params) {
            _this.pageId = routeParams['pageId'];
            _this.userId = routeParams['userId'];
            _this.websiteId = routeParams['websiteId'];
        });
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        this.userService.findUserByUsername(this.username)
            .subscribe(function (searchedUser) {
            // console.log('server responded with a user of: ', searchedUser);
            if (searchedUser) {
                _this.errorMsg = 'The username "' + _this.username + '" is already taken! Please try another.';
                _this.errorFlag = true;
            }
            else {
                _this.user.username = _this.username;
                _this.user.password = _this.password;
                console.log('about to create a new user for', _this.username);
...
var WebsiteEditComponent = (function () {
    ...
    WebsiteEditComponent.prototype.handleRouteChange = function (routeParams) {
        var _this = this;
        this.activatedRoute.params
            .subscribe(function (params) {
            _this.websiteId = routeParams['websiteId'];
...
var WidgetEditComponent = (function () {
    ...
    WidgetEditComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params
            ...
            _this.websiteId = params['websiteId'];
            _this.userId = params['userId'];
            _this._widgetService.findWidgetById(_this.widgetId)
                .subscribe(function (widget) {
                _this.widget = widget;
            });
        });
...
var WidgetListComponent = (function () {
    ...
    WidgetListComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params
            ...
            _this.websiteId = params['websiteId'];
            _this.userId = params['userId'];
            _this._widgetService.findWidgetsByPageId(_this.pageId)
...
var PageServiceClient = (function () {
    function PageServiceClient(_http) {
        this._http = _http;
        this.page = { _id: '', name: '', websiteId: '', description: '' };
...
var WebsiteServiceClient = (function () {
    function WebsiteServiceClient(_http) {
        this._http = _http;
        this.website = { _id: '', name: '', developerId: '', description: '' };
        this.baseUrl = __WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].baseUrl;
        // websites = [
...
var WidgetServiceClient = (function () {
    function WidgetServiceClient(_http) {
        this._http = _http;
        this.widget = { _id: '', widgetType: '', pageId: '', size: 0, text: '', width: '', url: '' };
        this.baseUrl = __WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].baseUrl;
        // widgets = [
